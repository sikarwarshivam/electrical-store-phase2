...
import { ChevronRight, UserRound, Heart } from "lucide-react";
  ...
  return (
    <PageContainer title="My Account" description={"Signed in as " + user.name}>
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Link href="/account/wishlist" className="rounded-xl border border-neutral-200 bg-white p-5 hover:border-amber-400 dark:border-neutral-800 dark:bg-neutral-950">
          <Heart className="h-5 w-5 text-amber-600" />
          <p className="mt-3 font-bold">My Wishlist</p>
          <p className="mt-1 text-xs text-neutral-500">View saved products and add them to your cart.</p>
        </Link>
