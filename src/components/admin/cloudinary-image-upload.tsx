  ...
  return (
    <div className="space-y-3">
      ...
      {imageUrl ? (
        ...
        <div className="rounded-lg border border-dashed border-neutral-300 bg-neutral-50 p-4 text-center dark:border-neutral-700 dark:bg-neutral-900/50">
          <p className="text-sm font-medium">No image selected</p>
          <p className="mt-1 text-xs text-neutral-500">{acceptLabel}</p>
        </div>
      )}
      ...
      {uploading ? (
        <p className="text-xs text-neutral-500">
          Uploading securely. Keep this page open until it finishes.
        </p>
      ) : null}
