    ...
    <div className="space-y-3">
      ...
      {previewUrl ? (
        ...
        <div className="rounded-lg border border-dashed border-neutral-300 bg-neutral-50 p-5 text-center dark:border-neutral-700 dark:bg-neutral-900/50">
          <p className="text-sm font-medium">No banner image selected</p>
      ...
      <p className="text-xs text-neutral-500">
        The image is stored in Cloudinary automatically. You do not need to
        copy or paste an image URL.
      </p>
    </div>
  );
}
